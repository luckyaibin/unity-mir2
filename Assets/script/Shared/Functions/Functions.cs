...
public static class Functions
{
    ...
    public static float MaxDistance(Vector2 p1, Vector2 p2)
    {
    ...
    public static int Direction16(Vector2 source, Vector2 destination)
    {
        Vector2 c = source;
        Vector2 a = new Vector2(c.x, 0);
        Vector2 b = destination;
        float bc = Vector2.Distance(source, destination);
        float ac = bc;
        b.y -= c.y;
        c.y += bc;
        b.y += bc;
        float ab = Vector2.Distance(b, a);
