...
namespace ServerPackets
{
    ...
    public sealed class Magic : Packet
    {
        ...
        protected override void ReadPacket(BinaryReader reader)
        {
            ...
            Target = new Vector2(reader.ReadInt32(), reader.ReadInt32());
    ...
    public sealed class FishingUpdate : Packet
    {
        ...
        protected override void ReadPacket(BinaryReader reader)
        {
            ...
            FishingVector2 = new Vector2(reader.ReadInt32(), reader.ReadInt32());
        ...
        protected override void WritePacket(BinaryWriter writer)
        {
            ...
            writer.Write(FishingVector2.x);
            writer.Write(FishingVector2.y);
